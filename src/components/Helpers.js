...
/**
 * Returns an array of all CSS color strings in alphebetic order.
 * @returns {Array<string>} Array containing all CSS color strings
 */
export const getCssColorStrings = function() {
  return [
    'aliceblue',
    'antiquewhite',
    'aqua',
